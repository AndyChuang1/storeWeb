      ...
      <div class="col-sm">
        ...
        <div class="content">
          <div class="news">
            ...
            <ul>
              <li>【永盛堂中藥行官方網站開幕】<img :src="require('../assets/news.gif')" height="42" width="60"/></li>
              <li> ~ 我們提供給您最專業諮詢服務與品質~</li>
              <li>【公司地址】：(104)台北市中山區吉林路191號</li>
          ...
          <div class="news">
            ...
            <ol>
              <li>中華民國101年被選拔為優良商號。</li>
              <li>台北市商業會推行商業道德及商場禮貌選拔為優良從業人員。</li>
            </ol>
          </div>
